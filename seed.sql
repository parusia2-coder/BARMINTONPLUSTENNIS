...
INSERT OR IGNORE INTO participants (id, tournament_id, name, phone, level, paid, checked_in) VALUES 
  (1, 1, '김민수', '010-1234-5678', 's', 1, 1),
  (2, 1, '이정호', '010-2345-6789', 'b', 1, 1),
  (3, 1, '박서연', '010-3456-7890', 'a', 1, 1),
  (4, 1, '최유진', '010-4567-8901', 'c', 1, 0),
  (5, 1, '정다영', '010-5678-9012', 'd', 0, 0),
  (6, 1, '한승우', '010-6789-0123', 's', 1, 1),
  (7, 1, '윤지민', '010-7890-1234', 'b', 1, 1),
  (8, 1, '송현우', '010-8901-2345', 'e', 1, 0);
